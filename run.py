...
project = 'ps_vae'
videos = ['/Users/johnzhou/code/dlc_videos'
          '/B125_precon_topDLC_resnet101_FearConditioningTopNov27shuffle1_950000_filtered.mp4']
csv = '/Users/johnzhou/code/dlc_videos/B125_precon_topDLC_resnet101_FearConditioningTopNov27shuffle1_950000_filtered' \
      '.csv '

# Initialize your project
config = vame.init_new_project(
    project=project, videos=videos, working_directory=working_directory, videotype='.mp4')
os.system('cp /Users/johnzhou/code/dlc_videos'
          '/B125_precon_topDLC_resnet101_FearConditioningTopNov27shuffle1_950000_filtered.csv '
          '/Users/johnzhou/code/ps_vae-Aug05-2021/videos/pose_estimation')
...
os.system('rm -rf /Users/johnzhou/code/ps_vae-Aug05-2021')
